...
public class YinxingController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		YinxingEntity user = yinxingService.selectOne(new EntityWrapper<YinxingEntity>().eq("zhanghao", username));
    ...
    public R register(@RequestBody YinxingEntity yinxing){
    	...
    	YinxingEntity user = yinxingService.selectOne(new EntityWrapper<YinxingEntity>().eq("zhanghao", yinxing.getZhanghao()));
		if(user!=null) {
