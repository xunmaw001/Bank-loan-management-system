  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
        <h1 class="h1" style="color:#000;fontSize:28px;">银行贷款管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="账号" class="input" v-if="tableName=='yinxing'">
			...
			<el-form-item label="负责人" class="input" v-if="tableName=='yinxing'">
			  <el-input v-model="ruleForm.fuzeren" autocomplete="off" placeholder="负责人"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yinxing'" class="input-group">
			   <div class="label">咨询电话</div>
			   <div class="input-container">
			     <input v-model="ruleForm.zixundianhua" class="input" type="text" placeholder="咨询电话">
			   </div>
			 </div> -->
			<el-form-item label="咨询电话" class="input" v-if="tableName=='yinxing'">
			  <el-input v-model="ruleForm.zixundianhua" autocomplete="off" placeholder="咨询电话"  />
			</el-form-item>
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20210328/01993989e67e42d993cf2da794aa93ca.jpg");
		height: 100vh;
