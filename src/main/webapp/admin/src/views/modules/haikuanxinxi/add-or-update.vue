<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="还款日期" prop="haikuanriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.haikuanriqi" 
                type="date"
                placeholder="还款日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.haikuanriqi" label="还款日期" prop="haikuanriqi">
              <el-input v-model="ruleForm.haikuanriqi" 
...
export default {
  ...
  created() {
	this.ruleForm.haikuanriqi = this.getCurDate()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jine = true;
          ...
          if(o=='haikuanriqi'){
            this.ruleForm.haikuanriqi = obj[o];
	    this.ro.haikuanriqi = true;
            continue;
          }
          if(o=='yonghuming'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `haikuanxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.haikuanxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
