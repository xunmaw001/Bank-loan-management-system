<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="贷款额度" prop="daikuanedu">
          <el-input v-model="ruleForm.daikuanedu" 
              placeholder="贷款额度" clearable  :readonly="ro.daikuanedu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="贷款额度" prop="daikuanedu">
              <el-input v-model="ruleForm.daikuanedu" 
                placeholder="贷款额度" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="还款利率" prop="haikuanlilv">
          <el-input v-model="ruleForm.haikuanlilv" 
              placeholder="还款利率" clearable  :readonly="ro.haikuanlilv"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="还款利率" prop="haikuanlilv">
              <el-input v-model="ruleForm.haikuanlilv" 
                placeholder="还款利率" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="还款时间" prop="haikuanshijian">
          <el-input v-model="ruleForm.haikuanshijian" 
              placeholder="还款时间" clearable  :readonly="ro.haikuanshijian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="还款时间" prop="haikuanshijian">
              <el-input v-model="ruleForm.haikuanshijian" 
                placeholder="还款时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="贷款要求" prop="daikuanyaoqiu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="贷款要求"
                  v-model="ruleForm.daikuanyaoqiu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.daikuanyaoqiu" label="贷款要求" prop="daikuanyaoqiu">
                    <span>{{ruleForm.daikuanyaoqiu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="还款要求" prop="haikuanyaoqiu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="还款要求"
                  v-model="ruleForm.haikuanyaoqiu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.haikuanyaoqiu" label="还款要求" prop="haikuanyaoqiu">
                    <span>{{ruleForm.haikuanyaoqiu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  data() {
	...
	zhanghao : false,
      ...
      rules: {
          ...
          haikuanlilv: [
                { required: true, message: '还款利率不能为空', trigger: 'blur' },
          ],
          daikuanyaoqiu: [
          ],
          haikuanyaoqiu: [
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yinxingmingcheng = true;
          ...
          if(o=='daikuanedu'){
            this.ruleForm.daikuanedu = obj[o];
	    this.ro.daikuanedu = true;
            continue;
          }
          if(o=='haikuanlilv'){
            this.ruleForm.haikuanlilv = obj[o];
	    this.ro.haikuanlilv = true;
            continue;
          }
          if(o=='daikuanyaoqiu'){
            this.ruleForm.daikuanyaoqiu = obj[o];
	    this.ro.daikuanyaoqiu = true;
            continue;
          }
          if(o=='haikuanyaoqiu'){
            this.ruleForm.haikuanyaoqiu = obj[o];
	    this.ro.haikuanyaoqiu = true;
            continue;
          }
          if(o=='haikuanshijian'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.yinxingmingcheng!=''&&json.yinxingmingcheng){
